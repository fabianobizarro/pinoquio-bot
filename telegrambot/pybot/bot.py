...
class PyBot:
    ...
    def _train(self, train_data: list) -> None:
        ...
        :param train_data: A dictionary with training data in the following format:
            [
                {
    ...
    def train_sentence(self, sentence, class_name: str):
        train_data = {
            'class': class_name,
            'sentences': sentence if type(sentence) == type(list) else [str(sentence)]
        }
